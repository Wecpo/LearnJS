...
// При использовании setInterval - в задержку входит время выполнения кода, т.е.
// если например задежрка 1 сек, то вызовы будут выполняться через 1 сек - минус время кода.
//
// Если использовать вложенный setTimeout, то вызов будет происходить в конце предыдущего
// Т.е. вложенный setTimeout гарантирует фиксированную задержку.
