...
() => {
  ...
  // Обратите внимание на интересный момент: встроенные методы, такие как filter, map и другие
  // возвращают новые объекты унаследованного класса PowerArray.
  ...
  // именно используя arr.constructor, а не обычный массив.
...
() => {
  ...
  // Как вы видите, теперь .filter возвращает Array.
