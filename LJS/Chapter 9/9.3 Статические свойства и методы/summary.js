...
// Значением this при вызове User.staticMethod() является сам конструктор
// класса User (правило «объект до точки»).
...
() => {
  ...
  // Как это работает? Снова с использованием прототипов. Как вы уже могли предположить,
